...
::: columns
::: {.column width="50%"}
A broad framework for knowledge tracing models based on logistic regression @pavlik2021logistic
:::
...
::: {.column width="50%"}
::: columns
First member of the LKT family that ran in real-time @pavlik2009performance
:::
:::
...
-   Approximately equal predictive power across a lot of studies @pavlik2009performance, @gong2010comparing; @baker2011towards; @pardos2011ensembling; @pardos2012sum
...
-   A little higher AUC (0.003-0.027) @pavlik2021automatic
...
-   Examples
    ...
    -   Fluctuation in response time @chu2023predictiveness

    -   Different models of memory decay and spacing effect @Maier2023StudyingMD
